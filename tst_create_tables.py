...
class Testing(unittest.TestCase):
    ...
    #     self.assertTrue(res)
    #
    #     ##DatabaseHandler().deleteTable(gc.__table_nutrition_attribute_name__)
    #
    # def test_create_table_items_data(self):
    #     res = create_tables.create_table_items_data()
    #     self.assertTrue(res)
    #
    #     ##DatabaseHandler().deleteTable(gc.__table_items_data_name__)
    #
    # def test_create_table_daily_items(self):
    #     res = create_tables.create_table_daily_items()
    #     self.assertTrue(res)
    #
    #     ##DatabaseHandler().deleteTable(gc.__table_daily_items_name__)
